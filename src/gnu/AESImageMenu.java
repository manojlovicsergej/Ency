...
public class AESImageMenu extends JDialog {
	...
	public AESImageMenu() {
		...
		btnOpen_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JFileChooser chooser = new JFileChooser();
				chooser.showOpenDialog(chooser);
				...
				for(File file : files){
					if(file.getAbsoluteFile().toString().contains(".png")|| file.getAbsoluteFile().toString().contains(".jpg") || file.getAbsoluteFile().toString().contains(".jpeg")) {
		...
		btnOpen_1_1.setBounds(163, 469, 130, 39);
